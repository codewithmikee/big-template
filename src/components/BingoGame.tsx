 ...
 * Bingo Template
 * Version 3.0
 * App written by Mike Birhanu
 * https://github.com/codewithmikee/big-template
 */
// Dependencies
...
class BingoGame extends Component {
	...
	startNewGame = () => {
		...
		// Start with the Bingo Template call out
	 ...
	 */
	handleBugReport = () => {
		let subject = "Bingo Template bug report"
		let body = `Thank you for playing Bingo Template and for taking the time to report a bug! Please describe what is happening to you so I may fix it ASAP.`
					...
					<div className="container row justify-start align-start">
						...
						<div className="col grow min-size-350 padding-vertical-xxlg padding-horizontal-xxlg white-text">
							...
							<p className="wrap-text small-text">
								This edition of Bingo Template has been retired. Please try the
								latest edition that has many improvements at{" "}
								<a
