			...
			<section className="padding-vertical-xxlg">
				<div className="container row">
					<div id="top" className="col">
						...
						<h1 className="no-margin">Instructions for Bingo Template</h1>

						{/* --------------- Table of Contents --------------- */}
						<p>Please use the links below to guide you in your gameplay!</p>
						<ol>
							<li>
								<a href="#what-is-lpb">What is Bingo Template?</a>
							</li>
							<li>
						...
						{/* --------------- How do I use LPB? --------------- */}
						<h2 id="what-is-lpb">What is Bingo Template?</h2>
						<p>
							Bingo Template is a tool intended to be used for playing Bingo in
							a group setting - this can be either in person or online through
						...
						<p>
							Bingo Template utilizes an experimental technology called the Web
							Speech Synthesis API. This is primarily used for screen readers to
							read text back to vision impaired people. Support for this feature
							depends on your device and browser combination. If speech
							synthesis is not supported you will receive a message indiciating
							that the "Bingo Caller" option is not available for you. Please
							try another browser or different device if you'd like to use this
							feature.
						</p>
						...
						<p>
							...
							the caller will say "Bingo Template!" or if using the Wild Bingo
