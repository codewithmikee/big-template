				...
				<div className="container row">
					<div className="col padding-xxlg">
						...
						<p>
							...
							Created This LLC D/B/A ("doing business as") Bingo Template
						...
						<p>
							To be specific, Bingo Template only uses localStorage technologies
							which are strings of text stored in your browser to save
							information about your gameplay preferences and game data. These
							"cookies" do not expire, but if you clear your cookies in your
							browser they will disappear. We do not have a database, and we do
							not store information on any servers. When you visit our Site, we
							will send a request to your browser to check for these strings of
							text. If they exist we will retrieve them so we can resume your
							game or restore your preferences. This is not personal information
							about you, nor does it allow us to access personal information
							about you. It is strictly to improve your experience on the Site.
						</p>
